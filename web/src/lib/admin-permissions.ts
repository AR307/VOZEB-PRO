export const ADMIN_PERMISSION_DEFINITIONS = [
    { key: "analytics.read", label: "经营分析", description: "查看经营、生成和财务摘要。" },
    { key: "users.read", label: "用户查看", description: "查看用户账号与公开身份信息。" },
    { key: "users.manage", label: "用户运营", description: "创建、编辑、禁用和删除普通用户。" },
    { key: "administrators.manage", label: "管理员治理", description: "创建管理员并分配不超过自身范围的权限。" },
    { key: "generation.read", label: "生成记录", description: "查看生成任务、日志和媒体资产。" },
    { key: "generation.manage", label: "生成运维", description: "处理生成失败、人工确认和记录清理。" },
    { key: "commerce.manage", label: "商品营销", description: "管理套餐商品、促销、优惠券和邀请奖励。" },
    { key: "billing.read", label: "财务查看", description: "查看订单、流水、支付和对账摘要。" },
    { key: "billing.manage", label: "财务管理", description: "处理收款、退款、积分、支付配置和对账。" },
    { key: "upstream.manage", label: "上游配置", description: "管理模型渠道、路由、Skills 和生成参数。" },
    { key: "system.manage", label: "系统管理", description: "管理站点、邮件、存储、备份和数据维护。" },
    { key: "content.manage", label: "内容运营", description: "管理作品审核、举报申诉、公告和公共提示词。" },
    { key: "audit.read", label: "审计查看", description: "只读查看管理员和安全审计记录。" },
] as const;
