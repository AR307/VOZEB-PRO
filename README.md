...
| 授权方案             |               价格 | 核心范围                                                               |
| -------------------- | -----------------: | ---------------------------------------------------------------------- |
| 企业自营闭源年度授权 | 人民币 3,299 元/年 | 一个企业主体运营一个自有产品或品牌，授权期内闭源修改、部署和收费运营   |
| 企业自营闭源永久授权 |    人民币 7,999 元 | 一个企业主体永久闭源使用授权书列明的版本，不自动包含后续版本           |
| OEM / 第三方交付     |           暂不授权 | 不提供私有化交付、贴牌、转售、源码销售或向第三方部署整套系统的商业权利 |

自营闭源授权包含授权主体控制的开发、测试和生产环境，以及向该自有产品最终用户收费的权利；不包含转让、转授权、多个独立产品、VOZEB PRO 品牌权、第三方组件或服务费用、部署实施、定制开发、技术支持和 SLA。完整边界见[商业授权说明](COMMERCIAL_LICENSE.md)。
